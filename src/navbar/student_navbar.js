                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-10 d-flex align-items-center">
                            ...
                            <nav className="nav-menu d-none d-sm-block">
                                <ul>
                                    <li className='active'><Link to={{ pathname: "/Leaveform" }}>Home</Link></li>
                                    <li className="drop-down"><Link>View</Link>
                                        <ul>
                                            <li><Link to={{ pathname: "/Permissionresponsepage" }}>Confirm Letters</Link></li>
                                            <li><Link to={{ pathname: "/Rejectedpermission" }}>Rejection Letters</Link></li>
                                        </ul>
                                    </li>
                                    <li className="drop-down"><Link>Upload</Link>
                                        <ul>
                                            <li><Link to={{ pathname: "/Imageupload" }}>Upload Letter</Link></li>
                                        </ul>
                                    </li>
