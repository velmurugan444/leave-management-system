...
class Transportnavbar extends React.Component {
                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-10 d-flex align-items-center">
                            ...
                            <nav className="nav-menu d-none d-sm-block">
                                <ul>
                                    <li className='active'><Link to={{ pathname: "/Transportpage" }}>Home</Link></li>
                                    <li className="drop-down"><Link>Add</Link>
                                        <ul>
                                            <li><Link to={{ pathname: "/Transportpage" }}>Bus Route</Link></li>
                                        </ul>
                                    </li>
                                    <li className="drop-down"><Link>View</Link>
                                        <ul>
                                            <li><Link to={{ pathname: "/viewbuses" }}>Bus Route</Link></li>
                                        </ul>
                                    </li>
