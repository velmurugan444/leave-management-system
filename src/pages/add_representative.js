...
const Addrepresentativepage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (name === "" || rollno === "" || libraryid === "" || email === "" || password === "" || section === "" || year === "" || department === "" || address === "" || mobile === "") {
      ...
      var db = database.ref().child("class representative");
      await db.push({
        "name": name,
        "rollno": rollno,
        "libraryid": libraryid,
  ...
  return <>
    ...
    <Card className="leaveform-card">
      <Card.Body>
        <h2 className="text-center mb-4">ADD REPRESENTATIVE</h2>
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group controlId="formBasicSection">
            ...
            <br />
            <select className="representative-section" value={section} onChange={(e) => setSection(e.target.value)}>
          ...
          <Form.Group controlId="formBasicYear">
            ...
            <br />
            <select className="representative-section" value={year} onChange={(e) => setYear(e.target.value)}>
